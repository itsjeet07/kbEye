...
const CloseButton = styled.button<{ selected?: boolean }>`
  ...
  &:hover:enabled {
    ...
    theme &&
      css`
        opacity: 0.8;
        transition: transform ${theme.animation.speed.normal}
...
const ChildCamAdvancedConfirmModal = () => {
        ...
        <CardContent>
          ...
          <BottomContainer>
            <ContainerCheck>
              ...
              />
              <CheckboxLabel
                labelText={t('doNotShowAgain')}
                htmlFor='checkbox'
                onClick={() => setIsChecked(!isChecked)}
              />
            </ContainerCheck>
            <ButtonGroup>
              <BackButton design='secondary' onClick={handleClose}>
                {t('Common:back')}
              </BackButton>
...
export default ChildCamAdvancedConfirmModal;
